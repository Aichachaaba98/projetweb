                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <th >date_livraison</th>
                       <th >Total_livraison</th>
                       <th >etat</th>
                       <th>nom_livreur</th>
                        <th>contacter_livreur</th>
...
?>
                                       ...
                                       <td> <button name="etat"  onclick="return etatverif(<?php echo $x ?>);"><img src="images/eyes.png " ></button></td>
		...
		<div class="row">
			<div class="col-md-12">
				<ul class="social-media">
					...
					<li>
						<a href="">
							<i class="tf-ion-social-google"></i>
						</a>
					</li>
				</ul>
