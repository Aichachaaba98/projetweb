...
{
    $listecateg=$categ1->recherchercategorie($_GET['rechercher'],$_GET['champs']);
}
...
myFunction() {
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li ><a href="afficherlistecategorie.php"> <i class="menu-icon fa fa-table"></i>gestion des commandes</a>       </li>
                                    </li>          
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
                <div class="col-lg-8">
                    ...
                    <div class="card-header">
                            <strong>Afficher </strong> Les Catégories
                        </div>
                    <br><br>
                    <div class="card-body">
      ...
      <br><br>
 <div id='Table'>
<form method="GET" action="afficherlistecategorie.php " class="form-inline ml-3">
        ...
        <div class="input-group-append">
          <button class="btn btn-navbar" type="submit">
            <i class="fas fa-search"></i>
                                    ...
                                    <td>
                                        <select name="champs"> 
                                        <option selected>id_categorie</option>
                                         <option>nom</option>
...
<br><br>
 <a href="TelechargerListeC.php"><button  class="btn btn-outline-primary btn-sm m-0 waves-effect"> télecharger </button> </a>
