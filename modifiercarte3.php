...
if (isset($_GET['id_carte'])){
    $carteC=new carteC();
    $result=$carteC->recuperercarte($_GET['id_carte']);
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST">
<table>
<caption>Modifier Carte</caption>
<tr>
<td>ID carte</td>
<td><input type="number" name="id_carte" value="<?PHP echo $id_carte ?>"></td>
</tr>
<tr>
<td>Login</td>
...
<tr>
<td>Points</td>
<td><input type="number" name="points" value="<?PHP echo $points ?>"></td>
</tr>

<td><input type="submit" name="modifier" value="modifier"></td>
<td><input type="hidden" name="id_carte_ini" value="<?PHP echo $_GET['id_carte'];?>"></td>
</tr>
</table>
</form>
...
if (isset($_POST['modifier'])){
    $carte=new carte($_POST['id_carte'],$_POST['login'],$_POST['points']);
    $carteC->modifiercarte($carte,$_POST['id_carte_ini']);
    echo $_POST['id_carte_ini'];
?>
<script>
    location.replace("affichercarte.php");
</script>
<?php
}
?>
