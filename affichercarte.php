                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Afficher cartes de fidélité</strong>
    ...
    function PrintDiv() {    
       ...
       popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
        popupWin.document.close();
                ...
                <input type="hidden" value="<?PHP echo $row['id_carte']; ?>" name="id_carte"></form>
                                ...
                                <?php } ?>
                                 ...
                                 <a href="imprimer.php">VOIR LISTE PDF</a>
                            <br>
