<?php
$conn = new mysqli("localhost","root","","bazart");
$count=0;
if(!empty($_POST['add'])) {
    $subject = mysqli_real_escape_string($conn,$_POST["subject"]);
    $comment = mysqli_real_escape_string($conn,$_POST["comment"]);
    $sql = "INSERT INTO commentss (subject,comment) VALUES('" . $subject . "','" . $comment . "')";
    mysqli_query($conn, $sql);
}
$sql2="SELECT * FROM commentss WHERE status = 0";
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media bg-flat-color-4" href="indexnotif.php">
                        ...
                        <div class="dropdown for-message">
                            <button class="btn btn-secondary dropdown-toggle" type="button"
                                id="notification-icon " onclick="myFunction()"
