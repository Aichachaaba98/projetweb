...
<!--***********************************************************----->
  ...
  if (isset($_POST['id_categorie'])) {
    $categC = new categC();
    $result = $categC->recuperercategorie($_POST['id_categorie']);
 ...
 <form method="POST" action="modifiercategorie.php" name="formulaire" novalidate="novalidate" enctype="multipart/form-data" >
          ...
          <table >
              ...
              <tr>
                  <div class="col col-md-3">
                    <label  class=" form-control-label">id categorie</label>
                   </div>
                 <div class="col-12 col-md-9">
                 <input type="number" name="id_categorie" class="form-control" value="<?PHP echo $id_categorie ; ?>" id="id_categorie"required>
                                 
                </div>
                <center>
                <div id="id_categorie1"></div></center>
...
<tr><td>
  ...
  <tr>
            <td></td>
              <td><input type="hidden" name="idp" value="<?PHP echo $_POST['id_categorie']; ?>"></td>
          </tr>
       </table> 
    ...
    if (isset($_POST['id_categorie']) && isset($_POST['nom'])  &&   isset($_POST['description'])  ) {
    $categorie= new categorie ($_POST['id_categorie'],$_POST['nom'], $_POST['description']);
        $categorieC=new categC();
    $categorieC->modifiercategorie($categorie, $_POST['idp']);
    echo $_POST['idp'];
    
    
     echo " <script> window.location.assign('afficherlistecategorie.php'); </script>";
  }
    ?>
           <!-- ******************************************* -->
           </div>
      ...
      <div class="at-loginarea float-right">
            <form method="POST" action="afficherlistecategorie.php">
          <input type="submit" name="offre" value="voir categorie" class="btn btn-outline-primary btn-sm m-0 waves-effect">
            </form>
            </div>
 ...
 <script >
      ...
      if(document.formulaire.id_produit.value == ""){
            ...
            document.getElementById("id_categorie").style.backgroundColor = "#FFA07A" ;
            document.getElementById("id_categorie1").textContent = "Veuillez remplir ce champs" ;
            return false ;
