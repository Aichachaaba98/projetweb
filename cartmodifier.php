          ...
          <div class="block">
            <div class="product-list">
                ...
                <table class="table">
				  ...
				  ?>
							...
							<tr>
									...
									<td> <input type="number" name="quantite"  min="0" max="10" required placeholder="Entre 1 et 10"></td>
				...
				<?php
						...
						$element_panierC1=new element_panierC();
						$element_panierC1->modifierelement($_POST['id_panier'],$_POST['id_produit'],$_POST['quantite']);
                ...
                <a href="cart.php" class="btn btn-main pull-right ">Valider</a>
