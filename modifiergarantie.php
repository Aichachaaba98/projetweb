...
include "../cores/garantieC.php";
if (isset($_GET['id_garantie'])){
	$garantieC=new garantieC();
    $result=$garantieC->recuperergarantie($_GET['id_garantie']);
	foreach($result as $row){
		$id_garantie=$row['id_garantie'];
		$nature=$row['id_client'];
		$description=$row['id_produit'];
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST">
<table>
<caption>Modifier garantie</caption>
<tr>
<td>id garantie</td>
<td><?PHP echo $row['id_garantie']; ?></td>
</tr>
<tr>
<td>Client Id</td>
<td><input type="text" name="id_client" value="<?PHP echo $nature ?>"></td>
</tr>
<tr>
<td>Produit Id</td>
<td><input type="text" name="id_produit" value="<?PHP echo $description ?>"></td>
</tr>
<td>Produit Id</td>
<td><input type="date" name="date_g" value="<?PHP echo $description ?>"></td>
</tr>
...
<tr>
<td></td>
<td><input type="hidden" name="id_garantie_ini" value="<?PHP echo $_GET['id_garantie'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
	$garantie=new garantie($_POST['id_client'],$_POST['id_produit'],$_POST['date_g'],"en");
	$garantieC->modifiergarantie($garantie,$_POST['id_garantie_ini']);
	echo $_POST['id_garantie_ini'];
?>
<script>
