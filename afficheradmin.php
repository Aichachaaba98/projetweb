                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <strong class="panel-title">Afficher</strong>
                            </div>
    ...
    function PrintDiv() {    
       ...
       popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
        popupWin.document.close();
                ...
                <input type="hidden" value="<?PHP echo $row['login']; ?>" name="login"></form>
              </td>

 <!--<td><a href="ajoutercarte.php?login=<?PHP echo $row['login']; ?>">
   <input type="submit" name="boutoncarte" value="ajoutercarte"></a></td>       -->                  
                                        </tr>
                                <?php } ?>
                                    </tbody>
...
<button onclick="PrintDiv();" class="fa fa-print">  imprimer </button>
