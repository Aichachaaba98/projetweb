...
<head>
  ...
  <meta name="description" content="Baz'art E-Commerce ">
  
  <meta name="author" content="Themefisher.com">

  <title>Baz'art | E-commerce </title>
					...
					<div class="product-thumb">
						...
						<div class="preview-meta">
							<ul>
								...
								<li><form method="POST" action="ajouterElement_panier.php" >
                                     <input type="hidden" value="<?PHP echo "19" ?>" name="id_produit">
                                     <a href="cart.html">


                                     	<i class="tf-ion-android-cart"><input type="submit" name="ajouter" value="ajouter"></i></a>
