...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <strong class="panel-title">Ajouter une carte</strong>
                            </div>
 ...
 <tr>
                  <div class="col col-md-3">
                    <label  class=" form-control-label">ID carte</label>
                   </div>
                 <div class="col-12 col-md-9">
                 <input type="texte" name="id_carte" class="form-control" placeholder="ID">
              ...
              <tr>
                 ...
                 <div class="col-12 col-md-9">
                 <input type="text" name="login" class="form-control" placeholder="Login du client">
              ...
              <tr>
                 ...
                 <div class="col-12 col-md-9">
                 <input type="number" name="points" class="form-control" placeholder="Points de la carte">
...
<tr><td>
          ...
          <input  type="submit" name="ajouter" value="Ajouter"  class="btn btn-outline-primary btn-sm m-0 waves-effect">
 ...
 <div class="at-loginarea float-right">
            <form method="POST" action="affichercarte.php">
          <input type="submit" name="offre" value="Afficher la liste" class="btn btn-outline-primary btn-sm m-0 waves-effect">
            </form>
            </div>
