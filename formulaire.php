...
<!--***********************************************************----->
        ...
        <div class="breadcrumbs">
                <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <!-- ********************************************** -->
      <form method="POST" action="ajouterproduit.php" name="formulaire" novalidate="novalidate" enctype="multipart/form-data" >
         ...
         <div class="card-body card-block">
          <table >
              ...
              <tr>
                 ...
                 <input type="number" name="id_produit" class="form-control"  id="id_produit"required>
...
<tr><td>
          ...
          <input  type="submit" name="ajouter" value="ajouter"  class="btn btn-outline-primary btn-sm m-0 waves-effect" onclick="return verif()">
