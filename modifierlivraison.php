...
if (isset($_GET['id_livraison'])){
	...
	foreach($result as $row){
		...
		$total_livraison=$row['total_livraison'];
        $etat=$row['etat'];
...
<head>
    <script src="java/projet.js"></script>
    <meta charset="utf-8">
...
<tr>
<td>total_livraison</td>
<td><input type="number" name="total_livraison" value="<?PHP echo $total_livraison ?>"></td>
</tr>
...
<tr>
    ...
    <td>Cin_Livreur222</td>
    <td>
    <select name="cin_livreur" >
    <option selected> <?php echo $cin_livreur ?></option> 
        <?PHP  foreach($listelivreurs as $row) { ?>

<option> 
 <?php echo $row['cin_livreur']; }?>
                                                           </option> 
...
<tr>
<td></td>
<td><input type="submit" name="modifier" value="modifier" onclick="return modifierlivraison()"></td>
</tr>
<tr>
<td></td>
<td><input type="hidden" name="id_liv" value="<?PHP echo $_GET['id_livraison'];?>"></td>
<td><input type="hidden" name="id_co" value="<?PHP echo $_GET['id_commande'];?>"></td>
...
if (isset($_POST['modifier'])){
    ...
    if(!empty($_POST['date_livraison'])and isset($_POST['cin_livreur'])and isset($_POST['total_livraison']))
    { 
$livraison=new livraison($_POST['id_liv'],$_POST['id_co'],$_POST['cin_livreur'],$_POST['date_livraison'],$_POST['total_livraison'],$_POST['etat']);
	$livraisonC->modifierlivraison($livraison,$_POST['id_liv']);
	
	
	
	?>
    <script> location.replace('a.php');</script>
