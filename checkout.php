		...
		<div class="row">
			...
			<div class="col-md-4 col-xs-12 col-sm-4">
				...
				<div class="logo text-center">
					<a href="index.html">
						<!-- replace logo here -->
						<svg width="200px" height="29px" viewBox="0 0 155 29" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
         ...
         <div class="row">
            ...
            <div class="col-md-8">
               <div class="block billing-details">
                     <h4 class="widget-title">Billing Detail</h4>
                     ...
                     <div class="payment">
                        <div class="card-details">
                        	<table>
                        	 ...
                        	 <tr>
                        	 	<td><input type="checkbox" name="mode_payement" value="Visa"> <img src="images/visa">  </td>
                        	 	
                        	 </tr>


                        	 <tr>
                        	 	<td><input type="checkbox" name="mode_payement" value="PayPal"> <img src="images/paypal"> </td>
                        	 	
                        	 </tr>
                        	 <tr>
                        	    <td><input type="checkbox" name="mode_payement" value="MasterCard"> <img src="images/mastercard"> </td>
                        	   
                        	 </tr>

                        	 <tr>
                        	 	<td> <input type="submit" name="valider" value="valider" onclick="return ajoutercheck()"> </td>
                        	 </tr>
                            </table>
