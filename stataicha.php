...
$liv = $db->query("select COUNT(*) from commande")->fetchColumn();
 //var_dump($listelivreurs->fetchAll());

$reqq1= $db->query(" SELECT  COUNT(*) as v  from commande where (mode_payement= 'visa')");
$nbb1 = $reqq1->fetch();

$reqq2= $db->query(" SELECT  COUNT(*) as m  from commande where (mode_payement= 'mastercard')");
$nbb2 = $reqq2->fetch();

$reqq3= $db->query(" SELECT  COUNT(*) as p  from commande where (mode_payement= 'paypal')");
$nbb3 = $reqq3->fetch();

$dataPoints = array(
    array("label"=> "Visa", "y"=> intval($nbb1['v'])),
    array("label"=> "MasterCard", "y"=> intval($nbb2['m'])),
    array("label"=> "PayPal", "y"=> intval($nbb3['p'])),
...
<head>
  ...
  window.onload = function () {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                title: {
                    text: " Les statistiques des modes de payements les plus utilisés "
                },
