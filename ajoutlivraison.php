...
if (isset($_GET['id_commande'])){
    ...
    foreach($result as $row){
        ...
        $panier=$panierC->recupererpanier($id_panier);
            foreach($panier as $pan)
                {$prix_total= $pan['prix_total'];}
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li ><a href="historique2.php"> <i class="menu-icon fa fa-table"></i>Historique des commandes</a>                    </li>                <li ><a href="stataicha.php"> <i class="menu-icon fa fa-table"></i>Statistiques</a>                    </li>
...
<table>
<caption>Ajout livraison</caption>
<tr>
...
<tr>
<td>Cin livreur</td>
<td><input type="text" name="cin_livreur"></td>
</tr>
<tr>
<td>Total payement</td>
<td><input type="number" name="total_livraison"></td>
</tr>
<tr><td><input type="submit" name="ajouter" value="ajouter" onclick="return ajouterlivraison()"></td>
</tr>

<?php 
if (isset($_POST['ajouter']))
{
       if (isset($_POST['cin_livreur'])and isset($_POST['date_livraison'])and isset($_GET['id_commande']))
{  
    $livraison=new livraison(NULL,$_GET['id_commande'],$_POST['cin_livreur'],$_POST['date_livraison'],$prix_total+10);
    ...
    $valider="Validee";
    //$commande->set_etat("v");
    $commandeC->modifiercommande2($_GET["id_commande"],$valider);
?>
<script>
    location.replace("affichercommandes2.php");
</script>
<?php    
}
else
{ ?>
   <script>
    location.replace("ajouterlivraison.php");
</script>
