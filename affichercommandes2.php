<?PHP
include_once "../Cores/commandeC.php";
...
{
    $commandes=$commande1C->recherchercommande($_GET['rechercher'],$_GET['champs']);
}
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li ><a href="historique2.php"> <i class="menu-icon fa fa-table"></i>Historique des commandes</a>                    </li>                <li ><a href="stataicha.php"> <i class="menu-icon fa fa-table"></i>Statistiques des commandes</a>                    </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content table-responsive">
                                 <form method="GET" action="affichercommandes2.php " class="form-inline ml-3">
                                    ...
                                    <td>
                                        <select name="champs"> 
                                        <option selected>id_commande</option>
                                        <option>login</option>
                                        <option>id_panier</option>
                                        <option>date_commande</option>
                                        <option>etat</option>
                                        <option>mode_payement</option>
                                        </select>
                                 </form>
                                <table class="table">
                                    <thead class="text-info" style="text-align: center;">
                                    <th><font color="black">ID_CLIENT</font></th>
                                    <th><font color="black">ID_COMMANDE</font></th>
                                    <th><font color="black">ID_PANIER</font></th>
                                    <th><font color="black">DATE_COMMANDE</font></th>
                                    <th><font color="black">ETAT</font></th>
                                    <th><font color="black">MODE_DE_PAYEMENT</font></th>
                                    <th><font color="black">DETAILS</font></th>
                                    <th><font color="black">VALIDER</font></th>
                                    <th><font color="black">MODIFIER</font></th>
                                    <th><font color="black">SUPPRIMER</font></th>
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td><?php echo $row["id_commande"] ; ?></a></td>
                                        ...
                                        <td>
                                              ...
                                              <form method="POST" action="affichercontenucommande2.php">
                                                    <button name="contenu" ><img src="commandes/eyes.png"></button>
                                          ...
                                          <td>
                                                ...
                                                <?php if ($row["etat"]!='Validee')
                                                { 
                                                    ?> 
                                              <form method="GET" action="ajoutlivraison.php">
                                                    <button name="valider" ><img src="commandes/valider.png"></button>
                                                    <input type="hidden" value="<?PHP echo $row['id_commande']; ?>" name="id_commande">
                                          ...
                                          <td> 
                                              <form method="GET" action="modifiercommande.php">
                                                    <button name="modifier" value="modfier" ></button>
                                                    <input type="hidden" value="<?PHP echo $row['id_commande']; ?>" name="id_commande">
                                              </form>  
                                          ...
                                          <td> 
                                              ...
                                              <form method="POST" action="supprimercommande.php" >
                                                    <button name="supprimer" ><img src="commandes/corbeille.png"></button>
                                                    <input type="hidden" value="<?PHP echo $row['id_commande']; ?>" name="id_commande">
