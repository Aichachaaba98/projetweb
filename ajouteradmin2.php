                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                     ...
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="ajoutercarte3.php">Ajouter un admin</a></li>
        ...
        <div class="content mt-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <strong class="panel-title">Ajouter un admin</strong>
                            </div>
                            <form method="POST" action="ajouteradmin.php" enctype="multipart/form-data" >
         ...
         <div class="card-body card-block">
          <table >
             ...
             <!--<tr>
                  <div class="col col-md-3">
                    <label  class=" form-control-label">Photo Admin</label>
                   </div>
                 <div class="col-12 col-md-9">
                 <input type="file" name="avatar" class="form-control" placeholder="" id="avatar">
...
<td>
 ...
 <div class="at-loginarea float-right">
            <form method="POST" action="afficheradmin.php">
