...
if (isset($_GET['cin_livreur'])){
	$livreurC=new livreurC();
    $result=$livreurC->recupererlivreur($_GET['cin_livreur']);
...
<head>
    <script src="java/modiflivreur.js"></script>
    <meta charset="utf-8">
...
<tr>
<td>cin_livreur</td>
<td><input type="number" name="cin_livreur" value="<?PHP echo $cin_livreur ?>"></td>
</tr>
<tr>
<td>nom</td>
...
<tr>
<td>disponibilite</td>
<td><input type="text" name="disponibilite" value="<?PHP echo $disponibilite ?>"></td>
</tr>
<td><input type="submit" name="modifier" value="modifier" onclick="return modiflivreur()"></td>
<td><input type="hidden" name="id_livreur_ini" value="<?PHP echo $_GET['cin_livreur'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
	...
	$livreur=new livreur($_POST['id_livreur_ini'],$_POST['nom'],$_POST['prenom'],$_POST['tel'],$_POST['disponibilite']);
	$livreurC->modifierlivreur($livreur,$_POST['id_livreur_ini']);
	echo $_POST['id_livreur_ini'];
?>
<script>
	location.replace("c.php");
</script>
<?php
}
}
